			...
			<form action="{{ url('/accessories') }}" method="post" enctype="multipart/form-data">
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-sm">
							<label>Price</label>
							<input type="number" value="0" step="0.1" min="0" max="1000000"  name="Price" id="Price" class="form-control" required/>						
						</div>
						<div class="col-sm">
							<label>Stock</label>
							<input type="number" value="1" min="1" max="100000" name="Stock" id="Stock" class="form-control" required/>
						</div>
					</div>				
					<div class="form-group">
						<label>Photo</label>
			...
			<form action="{{ route('accessories.update','accessory_id') }}" method="post" enctype="multipart/form-data">
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-sm">
							<label>Price</label>
							<input type="number" value="0"  min="0" max="1000000" step="0.1" name="Price" id="Price" class="form-control" required/>														
						</div>
						<div class="col-sm">
							<label>Stock</label>
